...
public class TestMAdapter extends BaseAdapter{
	...
	public TestMAdapter(Context context, List<DoMainBean> data,VolleyNetHelper helper) {
		this.data = data;
	...
	//设置数据
	public void setData(List<DoMainBean> data){
		this.data = data;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DoMainBean bean = data.get(position);
		holder.addressText.setText(bean.getTitle());
		holder.nameText.setText(bean.getDesc());
		String imageUrl = data.get(position).getThumbnail();
//		helper.getImage(mContext, imageUrl, new ImageCallBack(mContext, holder.image));
