...
public class RecordListAdapter extends BaseAdapter{
    ...
    public RecordListAdapter(Context context,VolleyNetHelper helper, List<AllDataBean> datas){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.recordTextView = (TextView) convertView.findViewById(R.id.comment_list_item_textView);
        ...
        holder.recordTextView.setText(bean.getDesc());
